...
function countTwos(num) {
  ...
  for (let i = 0; i < numString.length; i++) {
    ...
    console.log('calculate base digit', (digitsPlace - 1) * 10 ** (digitsPlace - 2));
    ...
    // if currentDigit is gre ater than 2, take base + number of twos in digitsPlace
    // First, take base twos: 50 -> (2, 12, 22, 32, 42) = 5 (calculate above)
    // Next, Account for missing twos in digits place: 20 - 29 = 10
